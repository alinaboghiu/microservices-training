...
import bbc.cps.microservicestrainingbroker.Config._
import bbc.cps.microservicestrainingbroker.Servlets
...
class ScalatraBootstrap extends LifeCycle {
  ...
  def reportMetrics() = {
    if (isCloudWatchEnabled) {
      ...
      reporter.set(new Reporter(metricsContext, "BBCApp/microservicestrainingbroker", client, environment))
