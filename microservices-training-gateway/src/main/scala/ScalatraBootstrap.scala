...
import bbc.cps.microservicestraininggateway.Config._
import bbc.cps.microservicestraininggateway.Servlets
...
class ScalatraBootstrap extends LifeCycle {
  ...
  def reportMetrics() = {
    if (isCloudWatchEnabled) {
      ...
      reporter.set(new Reporter(metricsContext, "BBCApp/microservicestraininggateway", client, environment))
